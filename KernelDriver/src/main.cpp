...
namespace driver {
	...
	NTSTATUS device_control(PDEVICE_OBJECT device_object, PIRP irp) {
		...
		// Access the request object sent frum user mode
...
NTSTATUS driver_main(PDRIVER_OBJECT driver_object, PUNICODE_STRING registry_path) {
	...
	RtlInitUnicodeString(&device_name, L"\\Device\\CheatDriver");
	...
	RtlInitUnicodeString(&symbolic_link, L"\\DosDevices\\CheatDriver");
	...
	// Allow us to send small this "entry point" but params will be null
	SetFlag(device_object->Flags, DO_BUFFERED_IO);
	

	// Set the dricer handlers to our functions with our logic
	...
	debug_print("[+] Driver initialiazed successfully\n");
...
NTSTATUS DriverEntry() {
	...
	RtlInitUnicodeString(&driver_name, L"\\Driver\\CheatDriver");
